...
/**
 * Helper class to manage TLS connection with MQTT broker
 * 
...
public class MQTTSecurityHelper {
	...
	public SSLSocketFactory createSocketFactory(
			...
			final String clientKeyFileName) throws Exception
		{
			...
			final String clientKeyPassword = "aaaa1234";
			try
			{
	...
	private KeyManagerFactory createKeyManagerFactory(final String clientCertificateFileName,
			final String clientKeyFileName, final String clientKeyPassword) throws InvalidKeySpecException,
			NoSuchAlgorithmException, KeyStoreException, IOException, CertificateException, UnrecoverableKeyException {
	...
	private PrivateKey createPrivateKeyFromPemFile(final String keyFileName)
		...
		final File keyFile = ResourceUtils.getFile("classpath:./" + keyFileName);
	...
	private X509Certificate createX509CertificateFromFile(final String certificateFileName)
		...
		final File file = ResourceUtils.getFile("classpath:" + certificateFileName);
		if (!file.isFile()) {
